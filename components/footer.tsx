      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="lg:col-span-2">
            <h3 className="font-serif text-3xl font-bold mb-4">Sweet Memories</h3>
            <p className="text-background/80 leading-relaxed mb-6 max-w-md">
              Creating unforgettable celebrations at Penugonda's premier rooftop venue. Where every moment becomes a
              cherished memory.
            </p>
            <div className="flex gap-3">
              <Button
                size="icon"
                variant="outline"
                className="rounded-full bg-background/10 border-background/20 hover:bg-background hover:text-foreground transition-all"
                asChild
              >
                <a
              ...
              <Button
                ...
                asChild
              >
                <a href="https://wa.me/+919959340959" target="_blank" rel="noopener noreferrer" aria-label="WhatsApp">
          ...
          <div>
            ...
            <div className="space-y-3 text-sm">
              ...
              >
                ...
                <span>29-77, Prakasham Street, Near SBI Bank, Penugonda, West Godavari, AP 534320</span>
              </a>
              <a
              ...
              >
                ...
                <span>Sweetmemorie2025gm@gmail.com</span>
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-background/20 pt-8">
          <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm text-background/70">
            <p>© 2025 Sweet Memories. All Rights Reserved.</p>
            <p className="flex items-center gap-1.5">
              Made with <Heart className="w-4 h-4 fill-background/70" /> in Penugonda
            </p>
          </div>
        </div>
      </div>
